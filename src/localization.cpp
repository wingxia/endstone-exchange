...
constexpr std::array Translations{
    ...
    Translation{Message::Balance,
                {"§6可用余额：§e{}§r", "§6Available balance: §e{}§r", "§6可用餘額：§e{}§r",
                 "§6利用可能残高：§e{}§r"}},
    ...
    Translation{Message::EconomyAdminBalanceDisabled,
                {"UMoney 模式禁止使用 addbalance；请直接使用 UMoney 管理功能。",
                 "addbalance is disabled in UMoney mode; use UMoney administration directly.",
                 "UMoney 模式禁止使用 addbalance；請直接使用 UMoney 管理功能。",
                 "UMoney モードでは addbalance は無効です。UMoney の管理機能を直接使用してください。"}},
    ...
    Translation{Message::EconomyStatus,
                {"经济来源={}，未完成/待核对直接转账={}",
                 "Economy provider={}, unfinished/review direct transfers={}",
                 "經濟來源={}，未完成/待核對直接轉帳={}",
                 "経済プロバイダー={}、未完了/確認待ち直接転送={}"}},
    ...
    Translation{Message::FrameSaleSelfPurchase,
                {"不能购买自己挂牌的物品；请用 price 右击后取消挂牌。",
                 "You cannot buy your own listing. Right-click it with price to cancel instead.",
                 "不能購買自己掛牌的物品；請用 price 右擊後取消掛牌。",
                 "自分の出品は購入できません。price で右クリックして取り消してください。"}},
    ...
    Translation{Message::FrameSaleProtected,
                {"已挂牌的展示框受保护；左击可购买，卖家可用 price 右击管理。",
                 "Listed frames are protected. Left-click to buy; the seller can manage one with price.",
                 "已掛牌的展示框受保護；左擊可購買，賣家可用 price 右擊管理。",
                 "出品中の額縁は保護されています。左クリックで購入、出品者は price で管理できます。"}},
    Translation{Message::ProtectedRegion,
                {"交易所保护范围内不能修改方块。", "Blocks cannot be modified inside the protected exchange area.",
                 "交易所保護範圍內不能修改方塊。", "取引所の保護範囲内ではブロックを変更できません。"}},
    Translation{Message::BulkSellTitle,
                {"一键出售背包", "Sell inventory", "一鍵出售背包", "インベントリ一括販売"}},
    Translation{Message::BulkSellConfirmContent,
                {"可交易物品：{} 种，共 {} 件\n\n确认后将按当前最高收购价依次卖出；无人购买或未成交的余量将以每件 1u 挂单。没有设为交易物的物品会留在背包。",
                 "Tradable inventory: {} item type(s), {} item(s) total.\n\nAfter confirmation, items sell against the highest current bids. Anything with no buyer or left unmatched is listed for 1u each. Items that are not exchange products stay in your inventory.",
                 "可交易物品：{} 種，共 {} 件\n\n確認後將按目前最高收購價依次賣出；無人購買或未成交的餘量將以每件 1u 掛單。沒有設為交易物的物品會留在背包。",
                 "取引可能：{} 種類、合計 {} 個\n\n確認後、現在の最高買値から順に売却します。買い手がいない、または約定しなかった残りは1個1uで出品します。取引対象でないアイテムはインベントリに残ります。"}},
    Translation{Message::BulkSellConfirmButton,
                {"§a确认全部出售§r", "§aSell all tradable items§r", "§a確認全部出售§r",
                 "§a取引可能な全アイテムを販売§r"}},
    Translation{Message::BulkSellCancelButton,
                {"取消", "Cancel", "取消", "キャンセル"}},
    Translation{Message::BulkSellNoItems,
                {"背包中没有可交易物品；没有设为交易物的物品已保留。",
                 "There are no tradable items in your inventory. Non-exchange items were kept.",
                 "背包中沒有可交易物品；沒有設為交易物的物品已保留。",
                 "インベントリに取引可能なアイテムはありません。取引対象外のアイテムは保持されました。"}},
    Translation{Message::BulkSellCompleted,
                {"§a一键出售完成：{} 种、{} 件；市价成交 {} 件，1u 上架 {} 件，收入 {}，生成 {} 笔订单。没有设为交易物的物品已留在背包。§r",
                 "§aInventory sale complete: {} item type(s), {} item(s); {} sold at market, {} listed at 1u, {} earned across {} order(s). Non-exchange items stayed in your inventory.§r",
                 "§a一鍵出售完成：{} 種、{} 件；市價成交 {} 件，1u 上架 {} 件，收入 {}，產生 {} 筆訂單。沒有設為交易物的物品已留在背包。§r",
                 "§a一括販売完了：{} 種類、{} 個。成行で {} 個約定、{} 個を1uで出品し、収入は {}、注文は {} 件です。取引対象外のアイテムは残りました。§r"}},
    Translation{Message::BulkSellPartiallyCompleted,
                {"§e一键出售部分完成：已处理 {} 件（市价成交 {} 件，1u 上架 {} 件），生成 {} 笔订单；随后失败：{}。已完成订单不会回滚，未处理和非交易物品仍在背包。§r",
                 "§eInventory sale partially completed: {} item(s) processed ({} sold at market, {} listed at 1u) across {} order(s), then failed: {}. Completed orders remain; unprocessed and non-exchange items stay in your inventory.§r",
                 "§e一鍵出售部分完成：已處理 {} 件（市價成交 {} 件，1u 上架 {} 件），產生 {} 筆訂單；隨後失敗：{}。已完成訂單不會回滾，未處理和非交易物品仍在背包。§r",
                 "§e一括販売は一部完了しました。{} 個を処理（成行約定 {} 個、1u出品 {} 個）、{} 件の注文後に失敗：{}。完了済み注文は維持され、未処理・対象外アイテムは残ります。§r"}},
    Translation{Message::BulkSellFailed,
                {"一键出售失败：{}。未处理和非交易物品仍在背包。", "Inventory sale failed: {}. Unprocessed and non-exchange items remain in your inventory.",
                 "一鍵出售失敗：{}。未處理和非交易物品仍在背包。", "一括販売に失敗しました：{}。未処理・対象外アイテムはインベントリに残っています。"}},
    Translation{Message::BulkSellOpenFailed,
                {"无法打开一键出售确认框：{}", "Could not open the inventory-sale confirmation: {}",
                 "無法開啟一鍵出售確認框：{}", "一括販売の確認画面を開けませんでした：{}"}},
